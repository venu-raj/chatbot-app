...
import { NavItemChild, NavItemChildren } from "@workspace/utils/constants/nav";
...
export function AuthButton({ ...rest }) {
  return (
    <Link
      href={"/"}
      {...rest}
