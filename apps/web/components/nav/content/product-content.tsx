...
const products = [
  {
    icon: (
      <div className="flex size-4 items-center justify-center rounded bg-blue-400">
        <Plus className="size-2.5 text-blue-900" />
      </div>
    ),
    title: "ChatFlow Builder",
    description:
      "Drag-and-drop conversation designer with advanced logic for modern customer engagement.",
    href: "/builder",
    color: "#3b82f6",
  ...
  },
  {
    icon: (
      <div className="flex size-4 items-center justify-center rounded bg-green-400">
        <Plus className="size-2.5 text-green-900" />
      </div>
    ),
    title: "AI Analytics",
    description:
      "Real-time insights and conversation intelligence powered by AI.",
    href: "/analytics",
    color: "#36D78F",
  ...
  },
  {
    icon: (
      <div className="flex size-4 items-center justify-center rounded bg-purple-400">
        <Plus className="size-2.5 text-purple-900" />
      </div>
    ),
    title: "Multi-Channel",
    description:
      "Deploy chatbots across WhatsApp, Messenger, and your website seamlessly.",
    href: "/channels",
    color: "#a855f7",
