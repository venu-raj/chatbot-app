...
import { cn, isDowngradePlan, PLANS } from "@workspace/utils";
import { ToggleGroup } from "@workspace/ui/components/toggle-group";
import { Button } from "@workspace/ui/components/button";
import { PLAN_COMPARE_FEATURES } from "@workspace/utils/constantstsx/pricing/plan-compare";
            ...
            >
              {plans.map((plan, idx) => {
                ...
                const isDowngrade = Boolean(
                  stripeId && isDowngradePlan("free", plan.name)
                );
                  ...
                  >
                    ...
                    <div className="flex gap-3">
                      ...
                      {plan.name === "Enterprise" ? (
                        ...
                        <Button
                          text={"Upgrade"}
                          className="h-8 px-6 shadow-sm bg-black"
                        />
