  ...
  if (mobileOnly || isMobile) {
    return (
      <Drawer.Root open={openPopover} onOpenChange={setOpenPopover}>
        ...
        <Drawer.Portal>
          <Drawer.Overlay className="bg-background fixed inset-0 z-50 bg-opacity-10 backdrop-blur" />
          <Drawer.Content
          ...
          >
            ...
            <div className="bg-default flex min-h-[150px] w-full items-center justify-center overflow-hidden pb-8 align-middle shadow-xl">
              {content}
            </div>
          </Drawer.Content>
          <Drawer.Overlay />
    ...
    <PopoverPrimitive.Root open={openPopover} onOpenChange={setOpenPopover}>
      ...
      <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content
          ...
          side={side}
          className={cn(
            "animate-slide-up-fade border-border-subtle bg-background z-50 items-center rounded-lg border drop-shadow-lg sm:block",
            popoverContentClassName
          )}
          sticky={sticky}
