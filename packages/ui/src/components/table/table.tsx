...
import { LoadingSpinner, SortOrder } from "@workspace/utils/icons/index";
import { SelectionToolbar } from "./selection-toolbar";
import { TableProps, UseTableProps } from "./types";
import { cn } from "@workspace/utils/functions/cn";
import { deepEqual } from "@workspace/utils/functions/deep-equal";
import { isClickOnInteractiveChild } from "@workspace/utils/functions/is-click-on-interactive-child";
    ...
    return (
      ...
      >
        {row.getVisibleCells().map((cell) => (
          ...
          >
            <div className="flex px-10 w-full items-center justify-between overflow-hidden truncate">
